...
class RocDateConverterTest {
	...
	@Autowired
	RocDateConverter rocDateConverter;
	...
	void testConvert() {
		...
		LocalDate localDate1 = rocDateConverter.convert(date1);
		LocalDate localDate2 = rocDateConverter.convert(date2);
		LocalDate localDate3 = rocDateConverter.convert(date3);
